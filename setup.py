...
__pkg_name__ = 'minimappy'
__author__ = 'cwright'
__description__ = 'Bindings to minimap aligner.'
...
extensions.append(Extension(
    ...
    libraries=[],
    extra_objects=[os.path.join('minimap2','libminimap2.a')]
))
...
setup(
    ...
    entry_points={
        'console_scripts': [
            'minimappy = {}.libminimap:main'.format(__pkg_name__)
        ]
    },
    scripts=[]
)
