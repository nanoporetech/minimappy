...
latex_documents = [
  ('index', '{}.tex'.format(project), u'{} Documentation'.format(project),
   u'Oxford Nanopore Technologies', 'manual'),
]
...
man_pages = [
    ('index', project, u'{} Documentation'.format(project),
     [u'Oxford Nanopore Technologies'], 1)
]
...
texinfo_documents = [
  ('index', project, u'{} Documentation'.format(project),
   u'Oxford Nanopore Technologies', project, 'One line description of project.',
   'Miscellaneous'),
]
...
epub_title = project
epub_author = u'Oxford Nanopore Technologies'
epub_publisher = u'Oxford Nanopore Technologies'
epub_copyright = u'2017, Oxford Nanopore Technologies'
